...
require __DIR__.'/api/operations_reports.php';
require __DIR__.'/api/commissions.php';
require __DIR__.'/api/event_logs.php';
...
require __DIR__.'/api/bank_transactions.php';
...
require __DIR__.'/api/prospects.php';
require __DIR__.'/api/ai.php';
require __DIR__.'/api/data_migration.php';
