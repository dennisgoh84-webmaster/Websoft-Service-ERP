...
- [ ] **Answered 2026-09-26, to build** ([open-business-decisions.md #49](open-business-decisions.md#49-outstanding-questions-answered-by-pick-list-2026-09-26)):
  ...
  - [x] Bank Book: no direct keying; bank charges and interest go through Receipt / Payment. **Built 2026-09-26** (ACC-005): an "Other" Receipt / Payment Voucher against a GL account, banked with the usual Bank step. Bank interest marked exempt (ES) counts in the GST return's exempt supplies box (answered 2026-09-26, built).
  - [x] Credit Note document (GST and GL reversal, owner approval above the customer's limit). **Built 2026-09-26** (BILL-003): raised from the invoice row, approved on Accounts → Credit Note, printable. Follow-ups built 2026-09-26: lines / part quantities with goods returned to stock; issued straight away within the customer's limit; a paid invoice can be credited, the credit kept on the customer's account or refunded with a Payment Voucher.
