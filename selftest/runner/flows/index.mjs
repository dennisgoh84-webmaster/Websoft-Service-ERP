...
import { contract, creditNote, creditOnAccount, incident, jobOrder, product, prospect, quotation, quotationProductInvoice, receipt, salesInvoice, serviceRecord, softwareTask } from './sales.mjs'
